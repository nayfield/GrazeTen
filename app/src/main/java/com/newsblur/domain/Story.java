...
public class Story implements Serializable
{
  ...
  {
    return getIntelligenceTotal(intelligence.intelligenceTitle, intelligence.intelligenceAuthors, intelligence.intelligenceTags,
  ...
  public int hashCode()
  {
    ...
    {
      result = 37 * result + this.feedId.hashCode();
    }
    return result;
  }
