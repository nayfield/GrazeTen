...
public class SocialFeed
{
  ...
  public boolean equals(Object o)
  {
    ...
    boolean equals = (TextUtils.equals(userId, otherFeed.userId) && positiveCount == otherFeed.positiveCount
        && neutralCount == otherFeed.neutralCount && negativeCount == otherFeed.negativeCount && TextUtils.equals(photoUrl, otherFeed.photoUrl));
    return equals;
  }
