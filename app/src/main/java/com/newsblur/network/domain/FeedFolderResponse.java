...
public class FeedFolderResponse
{
  ...
  /**
   * Parses a folder, which is a list of feeds and/or more folders. Nested folders are flattened into a single list, with names that are heirarchical.
   * 
   * @param nestedFolderList
   *          a list of any parent folders that surrounded this folder.
   * @param folders
   *          the sink
   * @param name
   *          the name of this folder.
   * @param arrayValue
   *          the actual contents to be parsed.
   */
  private void parseFeedArray(List<String> nestedFolderList, Map<String, List<Long>> folders, String name, JsonArray arrayValue)
  {
