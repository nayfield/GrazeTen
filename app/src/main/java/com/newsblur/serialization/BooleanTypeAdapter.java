...
/**
 * A more forgiving type adapter to deserialize JSON booleans. Specifically, this implementation is friendly to backend code that may send numeric 0s and 1s for
 * boolean fields, on which the strict GSON base impl would choke.
 */
