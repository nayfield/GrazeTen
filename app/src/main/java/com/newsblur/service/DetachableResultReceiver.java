...
/**
 * This class is based on the Google I/O 2011 app's class of the same name. It allows for a resultreceiver to attach/detach to an activity and thus elegantly
